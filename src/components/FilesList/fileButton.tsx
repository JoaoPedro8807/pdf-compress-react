...
export const FileButton = ( { children, text }: FileButtonProps ) => {
  return (
    <StyledWrapper style={{width: '100%', display: 'flex', justifyContent: 'space-between'}}>
      <button className="Documents-btn">
        ...
        <p className="text"> {text ? text : 'Documento'} </p>
      </button>
      {children}
    </StyledWrapper>
  );
